              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-3 w-full overflow-hidden">
                      <p className="text-gray-900 font-medium text-sm leading-relaxed break-all">
