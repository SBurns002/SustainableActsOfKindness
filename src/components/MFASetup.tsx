  ...
  const verifyAndEnable = async () => {
    ...
    try {
      ...
      if (verifyData) {
        ...
        setDebugInfo('Verification successful! MFA is now enabled.');
        setStep('success');
        ...
        setError('Verification succeeded but no data returned. Please check if MFA is enabled in your profile.');
