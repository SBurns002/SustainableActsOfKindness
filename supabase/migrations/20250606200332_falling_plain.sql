/*
  # MFA System Cleanup and Maintenance

  This migration performs comprehensive cleanup of MFA-related data and provides
  system status information. It includes:

  1. User-specific MFA cleanup function
  2. Global cleanup of orphaned and expired data
  3. System status reporting
  4. Cleanup execution for specific user
*/
